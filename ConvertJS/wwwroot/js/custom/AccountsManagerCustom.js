...
var KTAppAccountManager = function () {
    ...
    var initDatatable = function () {
        ...
        datatable = $(table).DataTable({
            ...
            'columnDefs': [
                ...
                { orderable: false, targets: 12 }, // Disable ordering on column 7 (actions)
            ]
        });
    ...
    var handleStatusFilter = () => {
        ...
        const filterType = document.querySelector('[data-kt-user-table-filter="type"]');
    ...
    return {
        init: function () {
            table = document.querySelector('#table_account');
